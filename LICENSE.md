...
All the files inside `static/images` directory are copyrighted to Vadim Abzalov.
All rights reserved.
...
Files not mentioned in previous paragraphs are licensed under APACHE LICENSE, VERSION 2.0
...
```text
   ...
   Copyright 2021-2021 Vadim Abzalov
